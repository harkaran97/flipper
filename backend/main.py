...
from app.api.rescore_all import router as rescore_all_router
from app.api.trigger_poll import router as trigger_poll_router
...
app.include_router(trigger_poll_router, prefix="/api/v1")
app.include_router(rescore_all_router, prefix="/api/v1")
