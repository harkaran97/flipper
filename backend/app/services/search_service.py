...
1. eBay sold comps < 3 (market value fallback — TASK_005)
2. Parts price lookup for repair estimation
...
async def search_market_value(
    ...
    Returns structured_data with median_sold_price_gbp, price_range_low_gbp,
    price_range_high_gbp from the LinkUp structured output.
    """
